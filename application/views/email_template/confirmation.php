...
<div style="width: 900px; margin:auto; border: 1px solid #CECECE;">
  <div style="font-family:'Brandon',Helvetica,Arial!important;font-size:16px;color:#30373b;background-color:#fff; margin: 25px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><p style="text-align: center;">Order Confirmation Email (Automatic)</p></td>
      </tr>

      <tr>
        <td style="padding:5px;">
              <p style="text-align:center;">Hi <?php echo $first_name;?></p>
        </td>
      </tr>
      <tr>
        <td style="padding:5px;"><table width="100%">
              <p style="text-align:center;">Your order at Moonstone Plates has been confirmed for the following number plate:</p>
