...
<div style="width: 900px; margin:auto; border: 1px solid #CECECE;">
  <div style="font-family:'Brandon',Helvetica,Arial!important;font-size:16px;color:#30373b;background-color:#fff; margin: 25px;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><p style="text-align: center;">Order ha been dispatched(Manual)</p></td>
      </tr>
      <tr>
        <td  height="10"></td>
      </tr>
      ...
      <tr>
        <td style="padding:5px;"><table width="100%">
              <p style="text-align:center;">Your order at Moonstone Plates for the following number plate:</p>
              <p style="text-align:center;font-size: 20px;"><b><?php echo $plate_number;?></b></p>
              <p style="text-align:center;">Has neen Dispatched and is on route to you!</p>
              <p style="text-align:center;">Thank you for choosing Moonstone Plates.</p>
