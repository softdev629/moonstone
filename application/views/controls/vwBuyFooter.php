               ...
               <div class="f-post-sec">
                  <div class="f-post">
                     ...
                     <div class="f-post-right">
                        ...
                        <div class="f-post-right-time-sec"><img src="<?php echo HTTP_ASSETS_PATH_CLIENT; ?>images/time-icon.png"> June 26. 20120</div>
                     </div>
                  </div>
                  <div class="f-post">
   ...
   <div class="footer-bottom">
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="footer-link"><a href="<?php echo base_url(); ?>terms-condition">Terms  & conditions</a>  |  <a href="<?php echo base_url(); ?>privacy-policy">privacy policy</a></div>
         </div>
      </div>
   </div>
</footer>
        ...
        <div class="m-t-30 m-b-20" style="padding-left: 20px; padding-right: 20px;">
              ...
              <div class="form-group text-center m-t-20">
                  <div class="col-xs-12 m-btn">
					...
					<a data-toggle="modal" id="all_login_modal" style="color: white;margin-bottom: 10px; display:none;" class="btn btn-styled btn-base-1">Already have one</a>
...
<div class="modal register" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  <div class="text-center m-t-20 m-b-20">
            <a href="index.html" class="logo">
                <img src="https://www.moonstoneplates.com/assets/images/logo-black.svg" alt="logo">
            </a>
        </div>
