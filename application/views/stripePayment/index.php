   ...
   <div class="row">
    ...
    <div class="row">
      <div class="col-md-12" style="text-align: center;">
        <button class="btn btn-primary btn-block" style="width: 200px;text-align: center;"  onclick="pay(100)">Pay $100</button>
      </div>
    </div>
</div>
...
<script type="text/javascript">
  ...
  function pay(amount) {
    var handler = StripeCheckout.configure({
      key: 'pk_test_NnFkzcCGatx9R3JrAkDNHcDT00uUCNA58Q',
      locale: 'auto',
