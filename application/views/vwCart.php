  ...
  <div class="container">
      <div class="row cols-xs-space cols-sm-space cols-md-space">
        ...
        <?php } ?>
            ...
            <a href="<?php base_url(); ?>customerinformation" class="buy" id="checkout-btn">
              <i class="fa fa-shopping-bag mr-1"></i> Checkout 
              </a>
              <div class="clearfix"></div>
              <br />
              <a href="reg?search=<?php echo $this->session->userdata('search_type'); ?>" class="buy">
                   <i class="ion-android-arrow-back"></i>
                                    Back
               </a>
