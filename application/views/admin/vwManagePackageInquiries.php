                                    ...
                                    <table class="table table-striped table-bordered m-b-0" id="gridTable">
                                       ...
                                       <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td><?php echo $this->common->GetValue('package','name','id',$vals['package_id']);?></td>
                                             <td><?php echo $vals['promotion_name'];?></td>
                                             <td><?php echo $vals['promotion_number'];?></td>
                                             <td><?php echo $vals['promotion_contact_number'];?></td>
                                             <td><?php echo $vals['promotion_email'];?></td>
                                             <td><?php echo $vals['promotion_message'];?></td>
