         ...
         <div class="row">
            ...
            <div class="card-box">
                  <div class="table-rep-plugin">
                     <div class="">
                        <form class="da-home-form form-horizontal" method="post" action="<?php echo base_url(); ?>admin/users/edit_company/<?php echo $user_data[0]['id'];?>" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-lg-6 col-sm-6 col-xs-6 col-md-12 col-xl-12">
                                    <fieldset class="form-group">
                                       <label for="name">Company Name<span class="required">*</span></label>
                                       <input type="text" name="name" class="form-control" id="name"
                                          placeholder="Company Name" required="" value="<?php if(isset($_POST["name"])){ echo $_POST["name"];}else{ echo $user_data[0]['name'];}?>">
                                    </fieldset>
                              </div>
