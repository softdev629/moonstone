                  ...
                  <div class="row">
                    <div class="col-xs-12">
                       <div class="page-title-box">
                          ...
                          <div class="add-page">
                             <a href="<?php echo base_url(); ?>admin/users/add_company" style="margin-left: 6px;font-size: 17px;"><i class="fa fa-plus" aria-hidden="true"></i></a>
                          </div>
                                    ...
                                    <table class="table table-striped table-bordered m-b-0" id="gridTable">
                                       ...
                                       <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                              <a href="<?php echo base_url(); ?>admin/users/edit_company/<?php echo $vals['id'];?>"><?php echo $vals['name'];?></a></td>
                                             <td>
                                                <?php
                                                if($vals['status']==1)
                                                {
