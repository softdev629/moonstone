            ...
            <div class="account-bg">
                <div class="card-box m-b-0">
                    ...
                    <div class="m-t-30 m-b-20">
                        ...
                        <form class="form-horizontal m-t-20 da-home-form" action="<?php echo base_url(); ?>admin/user_login_process" method="post">

                            <div class="form-group ">
                                <div class="col-xs-12">
                                    <input class="form-control" id="username" name="username" type="email" required="" placeholder="Email">
                                </div>
                            </div>
