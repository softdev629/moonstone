         ...
         <div class="row">
            <div class="col-xs-12">
               <div class="page-title-box">
                  ...
                  <div class="add-page">
                     <a href="<?php echo base_url(); ?>admin/buy-content/edit/<?php echo $content_page->id;?>" style="float:right;"><i class="fa fa-backward" aria-hidden="true"></i>Back</a>
                  </div>
            ...
            <div class="card-box">
               ...
               ?>
                  <div class="table-rep-plugin">
                     <div class="">
                        <form class="da-home-form form-horizontal" method="post" action="<?php echo base_url(); ?>admin/buy-content/edit/<?php echo $content_page->id;?>" enctype="multipart/form-data">
                           <div class="row">
                            ...
                            <a href="<?php echo base_url(); ?>admin/buy-content/edit/<?php echo $content_page->id;?>" class="btn btn-primary">Cancel</a>
                        </form>
                     </div>
                  </div>
               </div>
