...
class Update_Model extends CI_Model {
    ...
    public function update_cherished_plates($data, $condition) {
 	...
 	public function update_new_plate_status($data, $prefix, $numbers, $letters, $cron_tbl_id) {
 	...
 	public function update_new_prefix_status($data, $prefix, $numbers, $letters, $cron_tbl_id) {
